...
fn main() {
	...
	//day12_I_dont_know::day12(path.to_owned() + "advent_of_code_2022/files/day11.txt");
	//day12_test::day12();
	day12::day12(path.to_owned() + "advent_of_code_2022/files/day12.txt");
	day13::day13(path.to_owned() + "advent_of_code_2022/files/day13.txt");
